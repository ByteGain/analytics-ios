...
{
    [self run:SEGEventTypeAttempt payload:
     [[SEGAttemptGoalPayload alloc] initWithEvent:goalName properties:@{"intervention":goalName} context:<#(nonnull NSDictionary *)#> integrations:<#(nonnull NSDictionary *)#>]
}
